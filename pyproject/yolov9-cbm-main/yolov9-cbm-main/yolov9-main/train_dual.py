...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='yolov9-C3-Attention+Bifpn+MPDIou.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco-fire.yaml', help='dataset.yaml path')
